...
namespace Divi {
    ...
    class ET_Builder_Global_Presets_Settings
    {
         ...
         */
        public static $allowed_products = array('customizer_settings' => array('divi' => '4.5', 'extra' => '4.5'), 'storage_migration' => array('divi' => '4.19.2', 'extra' => '4.19.2', 'divi-builder' => '4.19.2'));
        ...
        protected static $_module_additional_slugs = array('et_pb_section' => array('et_pb_section_fullwidth', 'et_pb_section_specialty'), 'et_pb_slide' => array('et_pb_slide_fullwidth'), 'et_pb_column' => array('et_pb_column_specialty'));
        protected static $_module_types_conversion_map = array('et_pb_section' => '_convert_section_type', 'et_pb_column' => '_convert_column_type', 'et_pb_column_inner' => '_convert_column_type', 'et_pb_slide' => '_convert_slide_type');
        protected static $_module_import_types_conversion_map = array('et_pb_section_specialty' => 'et_pb_section', 'et_pb_section_fullwidth' => 'et_pb_section', 'et_pb_column_inner' => 'et_bp_column', 'et_pb_slide_fullwidth' => 'et_pb_slide', 'et_pb_column_specialty' => 'et_pb_column');
    ...
    class ET_Builder_Module_Signup extends \ET_Builder_Module_Type_WithSpamProtection
    {
        ...
        public $module_items_config = array('toggle_slug' => 'fields', 'location' => 'bottom', 'show_if' => array('use_custom_fields' => 'on'), 'show_if_not' => array('function.hasPredefinedFields' => 'off', '${provider}_list' => array('0|none', '')));
        function init()
        {
        }
    ...
    abstract class ET_Builder_Module_Field_Base
    {
         ...
         * @return array
         */
        public abstract function get_fields(array $args = array());
    }
    ...
    class ET_Builder_Module_Field_Sticky extends \ET_Builder_Module_Field_Base
    {
         ...
         */
        protected $defaults = array('prefix' => 'sticky', 'tab_slug' => 'custom_css', 'toggle_slug' => 'scroll_effects');
        /**
    ...
    class ET_Builder_Module_Field_Transform extends \ET_Builder_Module_Field_Base
    {
        ...
        public $defaults = array('scale' => '100%', 'translate' => '0px', 'rotate' => '0deg', 'skew' => '0deg', 'origin' => '50%');
    ...
    abstract class ET_Builder_Module_Field_Template_Base
    {
         ...
         * @return template
         */
        public abstract function render($field, $render_helper);
    ...
    abstract class ET_Builder_Module_Helper_Sizing
    {
         ...
         * @return string
         */
        public abstract function get_raw_field();
    ...
    class ET_Builder_Module_Settings_Migration_BorderOptions extends \ET_Builder_Module_Settings_Migration
    {
        ...
        public $defaults = array('all_modules' => array('width' => '0px', 'color' => '#ffffff', 'style' => 'solid'), 'post_based' => array('width' => '1px'), 'toggles_and_tabs' => array('width' => '1px', 'color' => '#d9d9d9', 'style' => 'solid'), 'et_pb_contact_form' => array('width' => '1px'), 'et_pb_contact_field' => array('width' => '14px', 'color' => '#bbb'), 'et_pb_blog' => array('width' => '1px', 'color' => '#d8d8d8', 'style' => 'solid'), 'et_pb_signup' => array('width' => '1px'));
        public function __construct()
        {
        }
    ...
    class ET_Builder_Module_Settings_Migration_ColumnOptions extends \ET_Builder_Module_Settings_Migration
    {
        ...
        public $fieldsWithSuffix = array('padding' => array('tablet', 'phone', 'last_edited', '_hover', '_hover_enabled'), 'padding_top' => array('_hover', '_hover_enabled'), 'padding_right' => array('_hover', '_hover_enabled'), 'padding_bottom' => array('_hover', '_hover_enabled'), 'padding_left' => array('_hover', '_hover_enabled'), 'background_color' => array('_hover', '_hover_enabled'), 'custom_css_before' => array('_hover', '_hover_enabled'), 'custom_css_main' => array('_hover', '_hover_enabled'), 'custom_css_after' => array('_hover', '_hover_enabled'));
        public $fieldsWithSuffixAppended = array('custom_padding' => '__no_suffix__', 'custom_padding_tablet' => 'custom_padding', 'custom_padding_phone' => 'custom_padding', 'custom_padding_last_edited' => 'custom_padding', 'custom_padding__hover' => '__no_suffix__', 'custom_padding__hover_enabled' => 'custom_padding', 'background_color__hover' => 'background_color', 'background_color__hover_enabled' => 'background_color', 'custom_css_before' => '__no_suffix__', 'custom_css_main_element' => '__no_suffix__', 'custom_css_after' => '__no_suffix__', 'custom_css_before__hover' => 'custom_css_before', 'custom_css_main_element__hover' => 'custom_css_main_element', 'custom_css_after__hover' => 'custom_css_after', 'custom_css_before__hover_enabled' => 'custom_css_before', 'custom_css_main_element__hover_enabled' => 'custom_css_main_element', 'custom_css_after__hover_enabled' => 'custom_css_after');
    ...
    class ET_Builder_Module_Settings_Migration_IconManager extends \ET_Builder_Module_Settings_Migration
    {
         ...
         * @var array
         */
        private $_icon_placement_migration_values = array('image_icon_width' => array('left' => '16px', 'top' => '48px'), 'image_icon_custom_padding' => array('left' => '8px|8px|8px|8px|false|false', 'top' => '25px|25px|25px|25px|false|false'), 'border_width_all_image' => array('left' => '2px', 'top' => '3px'));
        /**
